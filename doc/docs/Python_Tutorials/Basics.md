...
The simulation script for finding absorption with aluminum is in [examples/mie_absorption_Al.py](https://github.com/NanoComp/meep/blob/master/python/examples/mie_absorption_Al.py). Material data comes from the [materials library](../Materials.md#materials-library), and it can be noted that the resolution was increased in order to increase the accuracy of the calculation.
...
if mp.am_master():
    ...
    plt.tight_layout()
    plt.savefig("mie_absorption_Al.png")
```
